...
class MoreInfo {
  ...
  factory MoreInfo.fromJson(Map<String, dynamic> json) => MoreInfo(
        ...
        featuredStationType:
            _featuredStationTypeValues.map[json['featured_station_type']]!,
        query: json['query'],
        color: json['color'],
  ...
  Map<String, dynamic> toJson() => {
        ...
        'featured_station_type':
            _featuredStationTypeValues.reverse[featuredStationType],
        'query': query,
        'color': color,
        'language': language,
...
final _featuredStationTypeValues = _EnumValues({
  'artist': FeaturedStationType.ARTIST,
  'featured': FeaturedStationType.FEATURED
});
